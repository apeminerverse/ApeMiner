...
import "../../chainlink0.8/interfaces/VRFCoordinatorV2Interface.sol";
import "../../chainlink0.8//VRFConsumerBaseV2.sol";
import "../../../interfaces/IERC721RandomSeed.sol";

import "./ERC721PsiBatchMetaData.sol";

abstract contract ERC721PsiRandomSeed is
    IERC721RandomSeed,
    ...
    VRFConsumerBaseV2
{
    ...
    function _processRandomnessRequest(uint256 requestId, uint256 tokenIdHead)
        internal
    {}
